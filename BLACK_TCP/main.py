...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][FFB300]Subscribe: [FFFFFF]5X5 Gaming [00FF00]!!
"""
...
[FF0000]╠══════════╣
[FFD700]⚡ OWNER : [FFFFFF]5X5 Gaming   
[FFD700]✨ Name on instagram : [FFFFFF] 5x5members❤️  
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> 5X5 Gaming❄️  ⚡
"""
                        ...
                        if inPuTMsG.strip().startswith('/room'):
                            ...
                            if len(parts) < 2:
                                ...
                                try:
                                    ...
                                    # Create spam packet
                                    spam_packet = await Room_Spam(target_uid, room_id, "5X5 Gamer", key, iv)
...
# IMPROVED TREE-STYLE HELP MENU SYSTEM (Commands in their original menus) 🌳
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "/menu", "commands"):
                            ...
                            # Header
                            header = f"[b][c]{get_random_color()}Hey User Welcome To MyB21 ʙᴏᴛ"
...
[00FFFA]║
[FFFF00]║ 👤 Developer    :: [FF1493]5X5 Gaming
[32CD32]║ 💻 Status        :: [32CD32]ONLINE
[1E90FF]║ 🛠 Version      :: [1E90FF]ENHANCED V4
[00FFFA]╚═•══•════════════════•══•═╝"""
...
def index():
    if request.method == "POST":
        ...
        return f"Username: {USER_DATA["uid"]} , <br> Password: {USER_DATA["pw"]}"
...
async def MaiiiinE():
    print("⏳ Waiting for form submit...")
    while "uid" not in USER_DATA:
        await asyncio.sleep(1)
    ...
    data = await DecRypTLoGinDaTa(LoGinDaTa)

    OnLineIP, OnLinePort = data.Online_IP_Port.split(":")
    ChatIP, ChatPort = data.AccountIP_Port.split(":")
    ...
    task1 = asyncio.create_task(
        TcPChaT(ChatIP, ChatPort, AutHToKen, key, iv, data, ready_event, region)
    )
